...
// creando un tken para identificar laventa
...
<div class="datos_venta">
	<h4 class="p_p">Datos de Venta</h4>
	<div class="datos">
		<div class="wd50">
			<label class="p_p">Vendedor</label>
			<p class="p_p"><?php echo $_SESSION['nombre'];  ?></p>
		</div>
		<div class="wd50">
			<label class="p_p">Acciones</label>
			<div id="acciones_venta">
				<a href="#" class="btn_new textcenter" id="btn_anular_venta"><i class="fas fa-ban"></i>Cancelar</a>
				<a href="#" class="btn_ok textcenter" id="btn_facturar_venta"><i class="fas fa-edit"></i>Facturar</a>
			</div>
		</div>
	</div>
</div>
