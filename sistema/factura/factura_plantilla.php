...
<div id="page_pdf">
	<table id="factura_head">
		<tr>
			<td class="logo_factura">
				<div>
					<img src="img/LogoHPA.jpg" height="50">
				</div>
			</td>
			<td class="info_empresa">
				<div>
					<span class="h2">HERRAJES PARA ALUMINIO</span>
					<p>139 A Poniente #1305 San Bernabe Temoxtitla</p>
					<p>Teléfono: (222) 3752385</p>
					<p>Email: siac1ventas@hotmail.com</p>
				</div>
			</td>
	...
	<div>
		...
		<h4 class="nota">¡Gracias por su compra!</h4>
	</div>
