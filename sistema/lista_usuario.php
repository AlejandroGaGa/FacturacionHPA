...
<head>
	...
	<title>HPA | Usuarios Registrados</title>
</head>
<body>
	<?php 
	...
	<h1><i class="fas fa-users-cog"></i> Lista | Usuarios</h1>
	<a href="registro_usuario.php" class="btn_new"><i class="fas fa-user-ninja"></i>  Crear un nuevo usuario</a>
	<br>
    <br>
...
<form action="buscar_usuario.php" method="get" class="form_search">
	...
	<table>
		...
		$query = mysqli_query($conection, "SELECT u.idusuario, u.nombre, u.correo, u.usuario, r.rol FROM 
			usuario AS u INNER JOIN rol  as r ON u.rol = r.idrol WHERE estatus = 1 ORDER BY u.idusuario ASC LIMIT $desde,$por_pagina");
		...
		<tr>
			...
			<td>
				<a class="link_edit" href="editar_usuario.php?id=<?php echo $data['idusuario'] ?>"><i class="fas fa-edit"></i>

 Editar.</a><!--Paso el id por medio de php para poder indicar a que usuario actualizar-->
|
				<?php 
                 if($data['idusuario'] != 1){?>
				<a class="link_delete" href="eliminar_confirmar_usuario.php?id=<?php echo $data['idusuario'] ?>"><i class="fas fa-trash"></i>
