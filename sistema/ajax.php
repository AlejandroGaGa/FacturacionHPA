...
{
	$producto_id = $_POST['producto'];// esta variable ya almacena la variable para poder mandar mi procedimiento almacenado.
  ...
  //var_dump($query);
	...
	echo 'error';
	exit;
 //echo "Consultar Producto";

  }// finde if de info producto
  ...
  if($_POST['action'] == 'addProduct')
    ...
    //echo "Agregar producto";
		...
		{
			// creacion de variable para almacenar la información.       
        ...
        if($query_insert)
          {
           // INICIAR EL PROCEDIMIENTO CON PORCENTAJE
            ...
            exit;
          	...
          	}// fin de saber si el procedimiento arroja resultado

          }// fin de if query insert
          else
          {
            echo "error";
          }// fin de else del query

          mysqli_close($conection);
		}// fin de comprobación de si esta vacio o no 
		else{
			echo "error";
		} // si es que los campos van vacios retornare un error
		exit;
	}// fin de if de productos de entrada


  // inicio de info producto de eliminar 
 ...
 if($_POST['action'] == 'procesarVenta'){
   ...
   if(empty($_POST['codcliente'])){
    ...
    if($result > 0){
      ...
      if($result_detalle > 0)// SI ES MAYOR A 0 SI ME DEVUELVE LOS DATOS DE LA FACTURA
      {
      ...
      // fin de if de resultado de la consulta
    }else{
    echo "error";
    }
    mysqli_close($conection);
