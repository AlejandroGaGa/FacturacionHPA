		...
		<div class="divContainer">
			...
			<div class="dashboard">
					...
					<a href="lista_proveedor.php">
						...
						<p>
							<strong>Proveedores</strong><span>
								<?php echo $data_dash['proveedores']; ?>
							</span>
						</p>
					</a>
				<?php } ?>
				...
				<a href="ventas.php">
					...
					<p>
						<strong>Ventas del dia</strong><span>
							<?php echo $data_dash['ventas']; ?>
						</span>
					</p>
				</a>
			</div>
